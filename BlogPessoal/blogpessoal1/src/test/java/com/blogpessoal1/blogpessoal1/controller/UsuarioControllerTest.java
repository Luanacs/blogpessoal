...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		 ...
		 */
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastroUsuario(new Usuario(0L, 
	...
	public void deveListarApenasUmUsuario() {
		 ...
		 * de dados, o Optional evitará o erro NullPointerException (Objeto Nulo).
		 */
		Optional<Usuario> usuarioBusca = usuarioService.cadastroUsuario(new Usuario(0L, 
